...
interface EditPicsAdditionalInfoExperienceProps {
...
export const EditPicsAdditionalInfoExperience = (props: EditPicsAdditionalInfoExperienceProps) => {
    ...
    const renderDynamic = (label: string, items: string[], onChange: (i: string[]) => void, placeholder: string) => (
        <div>
            <div className="mb-2 flex items-center gap-2">
                <label className="font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-400">{label} ({items.length}/6)</label>
                {items.length < 6 && (
    ...
    return (
        <div className="space-y-6">
            ...
            {renderDynamic("Responsabilidades", props.responsibilities, props.onResponsibilitiesChange, "Responsabilidad")}
            {renderDynamic("Logros", props.achievements, props.onAchievementsChange, "Logro")}

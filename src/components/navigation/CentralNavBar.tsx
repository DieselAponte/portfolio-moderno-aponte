...
export default function CentralNavBar() {
  ...
  const hasMoreActive = moreItems.some((item) => isActivePath(pathname, item.href));

  return (
    <nav className="fixed left-1/2 top-6 z-50 w-[min(92vw,980px)] -translate-x-1/2">
      <div className="relative overflow-hidden rounded-[999px] border border-white/10 bg-black/70 px-4 py-3 backdrop-blur">
        ...
        <div className="relative flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          ...
          <div className="group relative">
            ...
            <div className="absolute left-1/2 top-full mt-3 w-44 -translate-x-1/2 opacity-0 transition group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:translate-y-0 group-focus-within:opacity-100">
